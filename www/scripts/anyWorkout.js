...
var workoutName = queryString.substring(5).replace('_', ' ');
...
for (var i = 0; i < localStore.length; i++) {
	console.log("LocalStore name: " + localStore[i].name.toString());
	console.log("Parameter name: " + workoutName);
	console.log(localStore[i].name.toString() == workoutName);
...
for (var k = 0; k < exerciseCount; k++) {
	...
	tableDataName.innerHTML = this.workout.exercises.shift();
